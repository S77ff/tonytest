      ...
      <v-container fluid>
        ...
        <v-card>
          <v-card-text>
            ...
            <BR /><BR />
            Rules: <h2>{{ currentRule }}</h2>
            <BR /><BR />
            Rules: <h3>{{ permissionPlusFile.Features[this.currentIndex].Rules.length === 0 ? 0 : ruleIndex + 1 }} / {{ permissionPlusFile.Features[this.currentIndex].Rules.length }}</h3>
            <!-- <BR /><BR />
...
export default {
  data() {
    return {
      ...
      array: ["Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 6", "Item 7", "Item 8", "Item 9", "Item 10", "Item 11", "Item 12", "Item 13", "Item 14", "Item 15", "Item 16", "Item 17", "Item 18", "Item 19", "Item 20"],
      currentIndex: 0,
